...
android {
    ...
    defaultConfig {
        applicationId = "dev.istmo.pendemo"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "0.1"
...
// under `native/android/`. Point Gradle at each plugin's directory so the
// files compile in place — no copies, no repackaging. Add one line per
// plugin the app enables.
