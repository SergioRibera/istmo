...
///
/// Instantiate one per `DataStoreConfig` through the generated
/// `DataStoreFactory` shape and register the dispatcher with the Swift-
/// side `IstmoRuntime`.
final class DataStoreBackendImpl: DataStoreBackend {
    ...
    func get_i64(key: String) async throws -> Int64? {
        ...
        // NSNumber-backed values come back as `Int` on 64-bit iOS.
